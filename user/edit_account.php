...
if(isset($_GET['edit_account'])){
    ...
    if(isset($_POST['user_update'])){
        ...
        if($result_query_update){
            echo "<script>alert('Data updated succeddfully')</script>";
...
<form action="" method="post" enctype="multipart/from-data" class="text-center">
    ...
    <input type="submit" value="Update" class="bg-info py- px-3 border-0" name="user_update">
</form>
</body>
</html>